...
{
    public ClientCommon(String name, long numberOfAccount, int password, double moneyOfAccount, Bank bank)
    {
        super(name,numberOfAccount,password,moneyOfAccount,bank);
        moneyTax = 30;
        System.out.printf(String.format("\nO %s é um cliente comum! Logo para realizar transfencias, pagará uma taxa adicional de %d reais\n",name,moneyTax));
    }
